...
use Illuminate\Foundation\Testing\RefreshDatabase; // Adicione se estiver usando factories que tocam o BD
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Symfony\Component\HttpFoundation\Response as SymfonyResponse;
use Tests\TestCase;
use Carbon\Carbon; // Adicionado para datas dinâmicas
